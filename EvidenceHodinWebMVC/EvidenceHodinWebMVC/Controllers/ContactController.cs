...
namespace EvidenceHodinWebMVC.Controllers
{
    public class ContactController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OwnerID,Name,Surname,Status")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OwnerID,Name,Surname,Status")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
